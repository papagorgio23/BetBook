...
# ## Testing American Odds
# convert_odds(odds = c(-1000, 110, 1200, 550, -110), input = "us", output = "all")
# convert_odds(odds = c(-1000, 110, 1200, 550, -110), input = "us", output = "dec")
# convert_odds(odds = c(-1000, 110, 1200, 550, -110), input = "us", output = "frac")
# convert_odds(odds = c(-1000, 110, 1200, 550, -110), input = "us", output = "prob")
# convert_odds(odds = c(-1000, 110, 1200, 550, -110), input = "us", output = "us")
# 
# ## Testing Decimals
# convert_odds(odds = c(1.1, 2.1, 13, 6.5, 1.909), input = "dec", output = "all")
# convert_odds(odds = c(1.1, 2.1, 13, 6.5, 1.909), input = "dec", output = "dec")
# convert_odds(odds = c(1.1, 2.1, 13, 6.5, 1.909), input = "dec", output = "frac")
# convert_odds(odds = c(1.1, 2.1, 13, 6.5, 1.909), input = "dec", output = "prob")
# convert_odds(odds = c(1.1, 2.1, 13, 6.5, 1.909), input = "dec", output = "us")
# 
# ## Testing Fractions
# convert_odds(odds = c(1/10, 11/10, 12/1, 11/2, 10/11), input = "frac", output = "all")
# convert_odds(odds = c(1/10, 11/10, 12/1, 11/2, 10/11), input = "frac", output = "dec")
# convert_odds(odds = c(1/10, 11/10, 12/1, 11/2, 10/11), input = "frac", output = "frac")
# convert_odds(odds = c(1/10, 11/10, 12/1, 11/2, 10/11), input = "frac", output = "prob")
# convert_odds(odds = c(1/10, 11/10, 12/1, 11/2, 10/11), input = "frac", output = "us")
# 
# ## Testing Probabilities
# convert_odds(odds = c(0.90909091, 0.47619048, 0.07692308, 0.15384615, 0.52380952), input = "prob", output = "all")
# convert_odds(odds = c(0.90909091, 0.47619048, 0.07692308, 0.15384615, 0.52380952), input = "prob", output = "dec")
# convert_odds(odds = c(0.90909091, 0.47619048, 0.07692308, 0.15384615, 0.52380952), input = "prob", output = "frac")
# convert_odds(odds = c(0.90909091, 0.47619048, 0.07692308, 0.15384615, 0.52380952), input = "prob", output = "prob")
# convert_odds(odds = c(0.90909091, 0.47619048, 0.07692308, 0.15384615, 0.52380952), input = "prob", output = "us")
# 
# 
# convert_odds(odds = 12/3, input = "frac", output = "all")
